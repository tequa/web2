...
angular.module('coretechsApp')
  .controller('RevenueCtrl', ['$scope', 'Course', '$q', function($scope, Course, $q) {
  	...
  	// TODO: move data to the service
        ...
        function loadData() {
            //$scope.performanceChartData = Course.getRatingData(Course.performancePeriod);
            if ($scope.revenuePeriod === 'week') {
                $scope.revenueChartData = [
                    {
                        "key": 'Middleware',
